...
const pages = ['Home', 'Contact us', 'Pricing'];
    ...
    <AppBar position="fixed" style = {{ background: 'Teal' }}>
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          {props.checkHomeStat && <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' }}}>
            <IconButton
              size="large"
         ...
         {props.checkHomeStat && <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
            {pages.map((page) => (
              <Button
                key={page}
